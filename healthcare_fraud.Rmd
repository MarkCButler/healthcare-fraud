---
title: 'Data Analytics for a Healthcare-Fraud Dataset'
output:
  html_document:
    code_folding: hide
    css: style.css
...
scope.  Terminology and data integrity are also discussed, and a summary of
the training data is presented.

The exploratory data analysis presented Sec. 3 has two goals:
...
The section ends with a summary of fraud associations.
